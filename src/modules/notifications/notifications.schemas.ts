...
export const notificationsQuerySchema = z.object({ cursor: z.string().max(2048).optional(), limit: limitSchema, filter: z.enum(["all", "unread", "likes", "replies", "mentions", "follows", "rewards"]).default("all") });
