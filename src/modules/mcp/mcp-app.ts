...
const verifiedMarkup = `<span class="verified" title="Verified PayMoment account" aria-label="Verified"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2.5 14.2 4l2.65-.08 1.1 2.41 2.3 1.32-.48 2.6 1.23 2.35-1.7 2.04-.08 2.65-2.5.91-1.7 2.04-2.48-.95-2.48.95-1.7-2.04-2.5-.91-.08-2.65-1.7-2.04 1.23-2.35-.48-2.6 2.3-1.32 1.1-2.41L9.8 4zM10.8 15.9 7.5 12.6l1.35-1.35 1.95 1.95 4.35-4.35 1.35 1.35z"/></svg></span>`;
...
function cardMarkup(card: Card, website?: string) {
  ...
  const mediaMarkup = media?.mime_type?.startsWith("video/") ? `<video class="media" src="${escapeHtml(safeUrl(media.url))}" controls playsinline preload="metadata"></video>` : media ? `<img class="media" src="${escapeHtml(safeUrl(media.url))}" alt="${escapeHtml(media.alt_text || "PayMoment attachment")}" />` : "";
